...
<div class="p-4">
    ...
    <p>
        You can create a new showcase item by creating a new file in the <code>_more</code> folder. It gives you the highest flexibility to customize the item using any HTML code.
    </p>
    <p>
